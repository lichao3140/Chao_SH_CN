...
/** 
 * DAO for table "RECOGNITION_RECORD".
*/
public class RecognitionRecordDao extends AbstractDao<RecognitionRecord, Long> {

    public static final String TABLENAME = "RECOGNITION_RECORD";

    /**
     * Properties of entity RecognitionRecord.<br/>
    ...
    public RecognitionRecordDao(DaoConfig config) {
        super(config);
    }
    
    public RecognitionRecordDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RECOGNITION_RECORD\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RECOGNITION_RECORD\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, RecognitionRecord entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, RecognitionRecord entity) {
        stmt.clearBindings();
    ...
    @Override
    public RecognitionRecord readEntity(Cursor cursor, int offset) {
        RecognitionRecord entity = new RecognitionRecord( //
    ...
    @Override
    public void readEntity(Cursor cursor, RecognitionRecord entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(RecognitionRecord entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(RecognitionRecord entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(RecognitionRecord entity) {
